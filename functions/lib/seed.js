...
exports.seedAthidhyam = (0, https_1.onRequest)(async (req, res) => {
    if (req.query.key !== "abc123seed") {
    ...
    try {
        ...
        await batch.commit();
        res.status(200).send(`Successfully seeded Athidhyam store and ${itemsCreated} items!`);
    }
    catch (err) {
